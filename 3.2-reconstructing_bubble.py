...
def main():
    # 定义输入和输出路径
    bubble_info_dir = r"C:\codebase\BFRM\results\yolo11l-obb\3-3Dbubble_positioning"
    bubble_csv_dir = r"C:\codebase\BFRM\results\yolo11l-obb\1-bubble_csv"
    output_dir = r"C:\codebase\BFRM\results\yolo11l-obb\3-simple_visualization"
    
    bubble_info_dir = r"C:\codebase\BFRM\results\RB_bubble_flow1\3-3Dbubble_positioning"
    bubble_csv_dir = r"C:\codebase\BFRM\results\RB_bubble_flow1\1-bubble_csv"
    output_dir = r"C:\codebase\BFRM\results\RB_bubble_flow1\3-simple_visualization"
    
    bubble_info_dir = r"C:\codebase\BFRM\results\RB_bubble_flow2\3-3Dbubble_positioning"
    bubble_csv_dir = r"C:\codebase\BFRM\results\RB_bubble_flow2\1-bubble_csv"
    output_dir = r"C:\codebase\BFRM\results\RB_bubble_flow2\3-simple_visualization"
